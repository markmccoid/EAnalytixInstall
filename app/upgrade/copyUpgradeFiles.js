...
const copyUpgradeFiles = (PROD_DIR, UPG_DIR, BAK_DIR) => {
  ...
  //-------------------------------------
	...
	let IncludeArraySTEP5 = [];

	//1. RENAME UPG/VariableEditor/--> qvVariable.json to UPG_qvVariables.json and GroupEditor/--> qvGroups.json to UPG_qvGroups.json
	IncludeArraySTEP1.push(fs.rename(path.join(UPG_DIR, 'Include/VariableEditor/data', 'qvVariables.json'), path.join(UPG_DIR, 'Include/VariableEditor/data', 'UPG_qvVariables.json')));
	IncludeArraySTEP1.push(fs.rename(path.join(UPG_DIR, 'Include/GroupEditor/data', 'qvGroups.json'), path.join(UPG_DIR, 'Include/GroupEditor/data', 'UPG_qvGroups.json')));
